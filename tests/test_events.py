...
class TestProcessBlock:
    def test_skips_transactions_without_recipient(self):
        block = MagicMock()
        block.transactions = [
            {'from': '0x' + '1' * 40, 'to': None, 'hash': MagicMock(hex=lambda: '0xabc')},
        ]
...
class TestInternalTransactions:
    ...
    def test_notifies_on_address_in_input(self, notify):
        ...
        with patch.dict(
            ...
            process_internal_transactions(block, accounts, token_addresses=[], block_txs=[])
    ...
    def test_skips_tx_to_token_contract(self, notify):
        ...
        with patch.dict(
            ...
            process_internal_transactions(
                block, {our_addr}, token_addresses=[token_contract], block_txs=[],
            )
        notify.assert_not_called()
    ...
    def test_skips_already_notified_regular_tx(self, notify):
        ...
        with patch.dict(
            ...
            process_internal_transactions(
                block, {our_addr}, token_addresses=[],
